...
assert(fn.includes('Do not say you cannot contact Mr Dietz directly') && fn.includes('private Telegram operator channel') && fn.includes('selected website language') && fn.includes("In German answers use 'Herr Dietz' as subject and 'Herrn Dietz'"), 'server prompt aligns Aria handoff wording with the selected website language while preserving correct German case');
