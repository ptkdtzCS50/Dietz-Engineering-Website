...
assert(fn.includes('return `${url.origin}${canonicalFunctionPath}`;'), 'operator reply URLs must fall back to /functions/v1/assistant when the runtime path is shortened');
